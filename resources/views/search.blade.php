                ...
                <div class="col-12">
                    ...
                    <div class="shop_toolbar_wrapper">
                        ...
                        <div class="page_amount">
                            <p>Showing {{ $searchProduct->total() }} results</p>
                        </div>
                    </div>
                    <!--shop toolbar end-->
                    ...
                    <div class="row no-gutters shop_wrapper" id='shop-product' >
                        ...
                        @foreach($searchProduct as $pros)
                       <div class="col-lg-4 col-md-4 col-12 " >
                           <div class="single_product">
                               <div class="product_thumb">
                                   <a href="{{ route('home.view',['id'=>$pros->id,'slug'=>$pros->slug]) }}"><img src="{{url('')}}/public/assets/img/product/{{ $pros->image }}" alt=""></a>
                                   ...
                                   <a href="" data-toggle="modal" data-target="#modal_box{{$pros->id}}"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                   </div>
                               </div>
                               <div class="product_content grid_content">
                                   <div class="product_name">
                                       <h3><a href="{{ route('home.view',['id'=>$pros->id,'slug'=>$pros->slug]) }}">{{$pros->name}}</a></h3>
                                   </div>
                    ...
                    <div class="shop_toolbar t_bottom">
                        ...
                        @endif
                        {{$searchProduct->appends(['key'=>request()->key,'select'=>request()->select])->links()}}
                    </div>
                    <!--shop toolbar end-->
                    <!--shop wrapper end-->
                </div>
